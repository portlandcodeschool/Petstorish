# RailsAdmin config file. Generated on October 25, 2012 12:00
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Petstorish', 'Admin']
  ...
  # config.excluded_models = ['Option', 'Order', 'Product', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Option', 'Order', 'Product', 'User']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your option.rb model definition
